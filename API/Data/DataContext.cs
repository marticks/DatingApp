...
namespace API.Data
{
    ...
    //esas tablas van a usar un int como ID
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyUtcDateTimeConverter(); //esto aplica lo de abajo

        }
    }

    //esto es una solución para el problema de que en la DB no se almacena el Datetime con la z para especificar que es utc
    //basicamente se aplica en el data context elevel y transforma las fechas a la salida de la DB así no lo tenes que hacer en otro lado
